...
assert.match(source, /if \(isAdminMode\) return;/u);
assert.doesNotMatch(source, /if \(!isVideoPortfolioPage \|\| isAdminMode\) return;/u);
assert.match(source, /coverPosition: item\.coverVariant \? item\.coverPosition : 'top'/u);
